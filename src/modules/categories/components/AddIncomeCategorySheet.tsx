// SmartSpend AI - Add Income Category Bottom Sheet Component
// Features:
// - Category name input
// - Color picker (green theme for income)
// - Icon picker (income-related icons)
// - Live preview card
...
interface AddIncomeCategorySheetProps {
  visible: boolean;
  onClose: () => void;
  onSave: (category: {
    name: string;
...
const ICON_OPTIONS = [
  { icon: 'cash', label: 'Tiền mặt' },
  { icon: 'card', label: 'Thẻ' },
  { icon: 'trending-up', label: 'Đầu tư' },
  { icon: 'briefcase', label: 'Công việc' },
  { icon: 'gift', label: 'Quà tặng' },
  { icon: 'heart', label: 'Từ thiện' },
  { icon: 'business', label: 'Kinh doanh' },
  { icon: 'wallet', label: 'Ví' },
  { icon: 'pricetag', label: 'Khuyến mãi' },
  { icon: 'ribbon', label: 'Thưởng' },
  { icon: 'school', label: 'Học bổng' },
  { icon: 'globe', label: 'Ngoại hối' },
];

const AddIncomeCategorySheet: React.FC<AddIncomeCategorySheetProps> = ({
  visible,
  onClose,
  onSave,
  initialData,
...
export default AddIncomeCategorySheet;
